...
from fetch_data import get_data, commodities  # Use get_data directly
...
for name in selected_commodities:
    try:
        df = get_data(commodities[name], name, period, interval)  # No caching
...
# Flatten columns if MultiIndex accidentally occurs
...
# Normalized price chart for comparison
